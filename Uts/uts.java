...
public class uts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Txt ke Doc & Docx");
    ...
    public static void writeDoc(String a) throws FileNotFoundException, IOException{
        Properties prop = new Properties();
        prop.setProperty("log4j.rootLogger", "WARN");
        PropertyConfigurator.configure(prop);
        
        String outDocEn = "F://hasil.doc";
    ...
    public static void writeDocx(String a) throws FileNotFoundException, IOException {
        Properties prop = new Properties();
        prop.setProperty("log4j.rootLogger", "WARN");
        PropertyConfigurator.configure(prop);
        
        XWPFDocument xWPFDocument = new XWPFDocument();
        String OutDocx = "F://hasil.docx";
        FileOutputStream outDocx = new FileOutputStream(new File(OutDocx));
        XWPFParagraph paragraph = xWPFDocument.createParagraph();
        XWPFRun runDocx = paragraph.createRun();
    ...
    private void openActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openActionPerformed
        ...
        chooser.setFileFilter(new FileTypeFilter(".txt", "Open File txt saja"));
